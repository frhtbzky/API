...
public class P14_Put_SoftAssertIleExpectedDataTesti {
...
/*
    ...
    public void put01(){
        ...
        bir sitede .com'dan sonra gelen ilk "/" ve her iki "/" arasindaki yerler path parametreleridir.

        ?'den sonraki kisimlar ise bizim icin artik query parametreleridir.Key ve value ikilileri seklindedir.
